...
export const Home = () => {
  ...
  return (
    <div className="bg-white">
      ...
      <BrandBar />
      <div id="featured">
        <FeaturedProducts filter="featured" title="Featured Collection" />
      </div>
      <BlogSection
      ...
      />
      <FeaturedProducts filter="bestsellers" title="Best Sellers" />
      <BlogSection
      ...
      />
      <FeaturedProducts filter="new" title="New Arrivals" />
      <div id="about">
        <AboutUs />
      </div>
      <div id="contact">
